...
function make_main_game_state(game) {
    function preload() {
        ...
        game.load.audio('bmusic', 'assets/battle.mp3');
    }
    ...
    function update() {
        ...
        if (randBattle === 99) {
            ...
            if(enemytype === 0) {
                ...
                enemy = game.add.sprite(player.world.x + 20, player.world.y + 15, 'enemy4');
            }
            else if(enemytype === 4){
                enemy = game.add.sprite(player.world.x + 20, player.world.y + 15, 'enemy5');
            }
            else {
                enemy = game.add.sprite(player.world.x + 20, player.world.y + 15, 'boss1');
            }
            //enemy = game.add.sprite(player.world.x + 20, player.world.y + 15, 'enemy');
